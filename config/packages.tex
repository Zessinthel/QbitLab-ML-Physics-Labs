...
\usepackage[backend=biber,
            style=numeric,           % estilo numérico (como plainnat)
            sorting=none,            % orden de aparición
            refsection=chapter,      % bibliografía independiente por capítulo
            natbib=true,             % compatibilidad con comandos \citet, \citep
            hyperref=true,
            backref=true,            % opcional: muestra página de cita
            ]{biblatex}
